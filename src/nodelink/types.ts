...
export interface WorkerFailedEvent
	extends Omit<PlayerEvent<NodelinkEventType.WorkerFailed>, "guildId"> {
	/**
	 * The affected guilds.
	 * @type {string[]}
	 */
...
export interface PlayerCreatedEvent
	extends PlayerEvent<NodelinkEventType.PlayerCreated> {
	/**
 ...
 */
export interface PlayerDestroyedEvent
	extends PlayerEvent<NodelinkEventType.PlayerDestroyed> {}

/**
 * The player connected event interface.
 */
export interface PlayerConnectedEvent
	extends PlayerEvent<NodelinkEventType.PlayerConnected> {
	/**
...
export interface PlayerReconnectingEvent
	extends PlayerEvent<NodelinkEventType.PlayerReconnecting> {
	/**
	 * The nodelink voice connection.
	 * @type {LavalinkPlayerVoice}
	 */
...
export interface VolumeChangedEvent
	extends PlayerEvent<NodelinkEventType.VolumeChanged> {
	/**
	 * The new volume.
	 * @type {number}
	 */
...
export interface FiltersChangedEvent
	extends PlayerEvent<NodelinkEventType.FiltersChanged> {
	/**
...
export interface ConnectionStatusEvent
	extends PlayerEvent<NodelinkEventType.ConnectionStatus> {
	/**
	 * The connection metrics.
	 * @type {NodelinkConnectionMetrics}
	 */
 ...
 */
export interface MixStartedEvent
	extends PlayerEvent<NodelinkEventType.MixStarted> {
	/**
	 * The mix identifier.
	 * @type {string}
	 */
