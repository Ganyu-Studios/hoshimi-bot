	...
	public override async run(ctx: GuildCommandContext<typeof options>) {
		...
		switch (options.type) {
			case "nightcore": {
				...
				return ctx.editOrReply({
					content:
						"Enabled the nightcore filter! The effect will be applied shortly.",
				});
			}
			...
			case "vaporwave": {
				...
				return ctx.editOrReply({
					content:
						"Enabled the vaporwave filter! The effect will be applied shortly.",
				});
			}
			...
			case "lowpass": {
				...
				return ctx.editOrReply({
					content:
						"Enabled the lowpass filter! The effect will be applied shortly.",
				});
			}
			...
			case "karaoke": {
				...
				return ctx.editOrReply({
					content:
						"Enabled the karaoke filter! The effect will be applied shortly.",
				});
			}
		}
	}
