 ...
 */
export class Lavalink<K extends keyof HoshimiEvents = keyof HoshimiEvents>
...
export const createLavalinkEvent = <K extends keyof HoshimiEvents>(
	event: LavalinkEvent<K>,
): LavalinkEvent<K> => new Lavalink<K>(event);
